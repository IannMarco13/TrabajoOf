...
<body>
    <div class="nombre">fsafa</div>

<header>
    <nav>
        <img src="assets/img/logocompleto-white.png" alt="Logo" class="logo-danicodex">
            ...
            <li class="develop">
                ...
                <ul class="ul-second">
                    <li class="front">
                        Chile - Bolivia
                        <ul class="ul-third"">
                            <li class="back"><a href="Mostrar_remesas.php">Remesas</a></li>
