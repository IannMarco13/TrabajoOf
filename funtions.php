<?php
function insertar_datos1($codigo, $fecha, $estado, $air, $agr, $ope, $origen, $crd, $destino, $moneda, $monto, $comision_por, $comision_clp, $recibido_usd, $recibido_clp, $total_clp, $remitente, $destinatario) {
    global $conexion;
 ...
 function insertar_datos2($codigo, $air, $fechaEnv ,$origen, $destino, $fechaPag, $estado, $monBob, $monUsd, $remitente, $destinatario) {
...
function insertar_datos3($codigo_b, $fecha_b,$correlativo_b,$documento_b,$usu_financiero, $telefono_U, $destinatario_b, $Telefono_d,$origen_b, $operador_b,$moneda_env,$destino_b,$monto_env,$por_com,$comision_b,$tipo_cambio,$monto_bob_b,$comison_bob,$Itf_bob,$ultima_modifi, $estado_b) {
    global $conexion;
 ...
 function insertar_datos4($fecha, $moneda_s, $resultado_s ,$tc_of, $saldo_bob, $cod_ag, $agencia_a) {
 ...
 function insertar_datos5($agencia_b,$moneda_b, $fecha_b, $saldo_b, $tc_oficial, $saldo_bob) {
