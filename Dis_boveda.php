...
<meta charset="UTF-8">
    ...
    <!-- CSS personalizado -->
    <link rel="stylesheet" href="assets/css/MTabla.css">
...
<body> 
    <br>
    <h1 class="text-center">Disponibilidad en Bóveda</h1>
    <div class="container">
                ...
                <tbody>
                    ...
                    if ($from_date && $to_date) {
                        ...
                        if(isset($_GET['from_date']) && isset($_GET['to_date'])){
                            $query ="SELECT * FROM disp_boveda WHERE DATE(FECHA_B) BETWEEN '$from_date' AND '$to_date' ORDER BY FECHA_B ASC, AGENCIA_B ASC;";
                        ...
                        <tr>
                            <td> <?php echo $cont; ?></td>
                            <td> <?php echo $fila['AGENCIA_B'] ?> </td>
                            <td> <?php echo $fila['MONEDA_B'] ?> </td>
                            <td> <?php echo date("d-m-Y", strtotime($fila['FECHA_B'])) ?> </td>
                            <td> <?php echo $fila['SALDO_B']?> </td>
                            <td> <?php echo $fila['TC_OFICIAL'] ?> </td>
