    ...
    <div class="container-c">
        ...
        <div class="table-responsive">
            <table id="TablaRemesas" border="3">
                ...
                <tbody>
                    <?php
                    $query = "SELECT CodigoMoneda AS MONEDA, CORTE FROM corte_monedas WHERE CodigoMoneda = 'NZD' ORDER BY CORTE DESC";
            ...
            <center>
                <input class="submit-button" type="button" value="Reset" onclick="Recet12()">
