...
<div class="container-c">
    <form action="" method="post" id="FormularioActaEntrega">
        <table id="TablaActa" border="1">
            ...
            <tbody>
            <?php
            $query = "SELECT tabla_monedas.Moneda,tabla_monedas.CodigoMoneda, VENTA, 
        ...
        <center>
            ...
            <?php if (!empty($mensaje) && $_SERVER['REQUEST_METHOD'] == 'POST'): ?>
                    ...
                    <?php endif; ?>
            <button class="submit-button" type="button" onclick=""><i class="far fa-file-pdf"> Imprimir</i></button>
